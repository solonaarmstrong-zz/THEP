...
<h1>Edit Article</h1>
<?php echo $form->create('News',array('url' => array('controller' => 'admin', 'action' =>'newsedit'),'type' => 'file'));  ?>
<? echo $form->hidden('id'); ?>
...
<table>
    ...
    <tr>
        <td>Text</td>
        <td><?php echo $form->input('text', array('type'=>'textarea','label'=>false,'rows'=> 15, 'cols'=>100)); ?></td>
    </tr>
    
    <tr>
        <td>Image</td>
        <td>
        <?php echo $upload->image($news, 'News.photo', array('style' => 'thumb')) ?><br />
    ...
    <tr>
        <td></td>
        <td>
            <?php echo $form->end(array('label' => 'Update Article', 'class'=>'adminbutton')); ?>
        </td>
    </tr>
